...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('⚠ No Results, Please Follow Request Tips !! \n ♀ Request Tips › [<a href="https://telegram.me/HEROFLiX/894"Click Here</a>]')
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if (st.status == enums.ChatMemberStatus.OWNER) or (str(userid) in ADMINS):
            ...
            await query.answer("You're Not Admin 🤷🏻‍♀️", show_alert=True)
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('I Have Sent You The File Privately', show_alert=True)
